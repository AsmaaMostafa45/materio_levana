  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        ...
        <v-slide-x-transition>
          <h2 class="app-title text--primary">Levana</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-link
        ...
        :to="{ name: 'tasks_projects' }"
        :icon="icons.mdiFileOutline"
      ></nav-menu-link>
      <nav-menu-group title="CRM" :icon="icons.mdiCellphoneMessage">
        <nav-menu-link title="Customers" :to="{ name: 'customers' }"></nav-menu-link>
        <nav-menu-link title="Deals" :to="{ name: 'deals' }"></nav-menu-link>
        <nav-menu-link title="Analytics" :to="{ name: 'analytics' }"></nav-menu-link>
      </nav-menu-group>
      <nav-menu-link
        title="chats and calls"
        :to="{ name: 'Chats_calls' }"
        :icon="icons.mdiPhoneMessageOutline"
      ></nav-menu-link>
      <nav-menu-group title="Company" :icon="icons.mdiOfficeBuildingOutline">
        <nav-menu-link title="Company Structure" :to="{ name: 'company_structure' }"></nav-menu-link>
        <nav-menu-link title="Employees" :to="{ name: 'company_employees' }"></nav-menu-link>
      </nav-menu-group>
      <!-- <nav-menu-section-title title="employees"></nav-menu-section-title> -->
      <nav-menu-link
        title="Account Settings"
        :to="{ name: 'pages-account-settings' }"
        :icon="icons.mdiAccountCogOutline"
      ></nav-menu-link>
      <!-- <nav-menu-link title="Iconstest" :to="{ name: 'iconstest' }" :icon="icons.mdiEyeOutline"></nav-menu-link>
      <nav-menu-link title="hr" :to="{ name: 'typography' }" :icon="icons.mdiAlphaTBoxOutline"></nav-menu-link>
      <nav-menu-link title="Icons" :to="{ name: 'icons' }" :icon="icons.mdiEyeOutline"></nav-menu-link>
      <nav-menu-link title="Cards" :to="{ name: 'cards' }" :icon="icons.mdiCreditCardOutline"></nav-menu-link>
      <nav-menu-link title="Tables" :to="{ name: 'simple-table' }" :icon="icons.mdiTable"></nav-menu-link>
      <nav-menu-link title="Form Layouts" :to="{ name: 'form-layouts' }" :icon="icons.mdiFormSelect"></nav-menu-link> -->
