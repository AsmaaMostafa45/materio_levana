      ...
      initialize () {
                ...
                axios.get('/cstDeal')
                    .then((response)=>{
                      ...
                      console.log('final_change', self.final_change)
                      //  var object = {statistics : response.data.deal_new_count}
                      //  self.$set(this.newDeal, object); 
                      // this.newDeal.statistics = response.data.deal_new_count
                      // Vue.set(self.newDeal, i , {
                      //       'statistics': response.data.deal_new_count
                      // });
                          // this.newDeal = {
                          //   statTitle: 'New Deal',
                          //   icon: mdiPoll,
                          ...
                          //   color: 'secondary',
                          //   subtitle: 'Past Month',
                          //   statistics: 'response.data.deal_in_progress_count',
                          //   change: '-15%',
                          // }
                          ...
                          //   statistics: 'response.data.deal_final_count',
                          //   change: '-18%',
                          // }
